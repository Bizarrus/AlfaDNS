...
<h6>Usage</h6>
<pre lang="php">$object|null = $dns->getDomain(string :  $name);</pre>
...
<h6>Usage</h6>
<pre lang="php">$int|null = $dns->getDomainID(string :  $name);</pre>
...
<h6>Usage</h6>
<pre lang="php">$object|null = $dns->getRecord(string | object :  $domain, string :  $type = '*', string :  $name);</pre>
